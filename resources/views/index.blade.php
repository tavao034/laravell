                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('images/social/search.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('images/social/spotify.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('images/social/telegram.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('images/social/snapchat.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('images/social/tiktok.png')}}" class="profile-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-4">
                                        <a class="dropdown-item text-center" href="#">
                                            <img src="{{asset('images/social/youtube.png')}}" class="profile-image img-fluid" alt="">
                        ...
                        <ul class="dropdown-menu bg-white shadow">
                            <li>
                                <div class="dropdown-menu-profile-thumb d-flex">
                                    <img src="{{asset('images/medium-shot-happy-man-smiling.jpg')}}" class="profile-image img-fluid me-3" alt="">
                            ...
                            <div class="custom-block custom-block-exchange">
                                ...
                                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('images/flag/united-states.png')}}" class="exchange-image img-fluid" alt="">
                                ...
                                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('images/flag/singapore.png')}}" class="exchange-image img-fluid" alt="">
                                ...
                                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('images/flag/united-kingdom.png')}}" class="exchange-image img-fluid" alt="">
                                ...
                                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('images/flag/australia.png')}}" class="exchange-image img-fluid" alt="">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('images/flag/european-union.png')}}" class="exchange-image img-fluid" alt="">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="custom-block custom-block-profile-front custom-block-profile text-center bg-white">
                                <div class="custom-block-profile-image-wrap mb-4">
                                    <img src="{{asset('images/medium-shot-happy-man-smiling.jpg')}}" class="custom-block-profile-image img-fluid" alt="">
                            ...
                            <div class="custom-block custom-block-transations">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('images/profile/senior-man-white-sweater-eyeglasses.jpg')}}" class="profile-image img-fluid" alt="">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('images/profile/young-beautiful-woman-pink-warm-sweater.jpg')}}" class="profile-image img-fluid" alt="">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('images/profile/young-woman-with-round-glasses-yellow-sweater.jpg')}}" class="profile-image img-fluid" alt="">
